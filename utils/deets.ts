...
const thourist =
  'THOURIST gives you an in-depth view into several popular sight and  tourist attractions in the world.Taking breath-taking shots of  spectacles around the globe, these gems have either been produced by the wonders of nature or by the intellect blessed upon man to craft these beautiful and memorable representations into existence.Ranging from islands, skyscrapers and ancient temples.';
const moreThourist =
